...
export function Login() {
   ...
   const onClick = async (event: React.MouseEvent<HTMLButtonElement>) => {
      ...
      if (id) {
         console.log(`User logged in with ID: ${id}, about to merge...`);
   ...
   return (
      <div>
         ...
         >
            ...
            <button
               className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition cursor-pointer w-30 mt-8 mx-auto"
               onClick={onClick}
            >
               Login
            </button>
